      ...
      <section class="pld-section">
        ...
        <div class="pld-grid3">
          <div v-for="item in inputs" :key="item.id" class="pld-input-card">
            <div class="pld-card-topline">
              <span class="pld-tag">{{ item.modalityName }}</span
              ><span class="pld-status-available">{{ item.status }}</span>
            </div>
      ...
      <section class="pld-section">
        ...
        <div class="pld-grid2">
          <div v-for="item in outputs" :key="item.id" class="pld-module-card">
            <div class="pld-card-topline">
              <span class="pld-tag">{{ item.outputType }}</span
              ><span class="pld-status-available">{{ item.status }}</span>
            </div>
