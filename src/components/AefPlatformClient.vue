...
.metaText, .newsDesc, .detailText { color: var(--muted); font-size: 13px; line-height: 1.65; }
...
.newsHeader { display: flex; justify-content: space-between; gap: 12px; align-items: flex-start; }
...
.badgeRow, .filterRow { display: flex; flex-wrap: wrap; gap: 8px; }
...
.filterButton { min-height: 34px; padding: 0 12px; border-radius: 999px; border: 1px solid rgba(148, 163, 184, 0.2); background: rgba(255, 255, 255, 0.04); color: var(--muted); cursor: pointer; transition: 0.18s ease; }
.filterButtonActive { color: #fff; border-color: rgba(96, 165, 250, 0.5); background: rgba(37, 99, 235, 0.35); }

.newsCard { border-radius: 20px; border: 1px solid rgba(148, 163, 184, 0.16); background: rgba(255, 255, 255, 0.05); padding: 16px; transition: 0.18s ease; }
.newsCard:hover { transform: translateY(-2px); border-color: rgba(96, 165, 250, 0.35); }
