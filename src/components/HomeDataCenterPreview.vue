...
.hdc-hero-row { display: grid; grid-template-columns: minmax(0, 1.1fr) minmax(320px, 0.9fr); gap: 24px; align-items: stretch; }

/* intro block */
.hdc-intro-block { display: flex; flex-direction: column; justify-content: center; gap: 16px; padding: 8px 0; }
.hdc-intro-block h3 { margin: 0; font-size: 32px; line-height: 1.1; letter-spacing: -0.03em; }

/* stat badges */
.hdc-stat-badges { display: flex; flex-wrap: wrap; gap: 10px; }
.hdc-stat-badge { display: flex; flex-direction: column; align-items: center; min-width: 72px; padding: 10px 14px; border-radius: 14px; background: rgba(255,255,255,0.04); border: 1px solid rgba(148,163,184,0.12); }
.hdc-stat-num { font-size: 22px; font-weight: 800; color: #7dd3fc; line-height: 1.2; }
.hdc-stat-label { font-size: 11px; color: #94a3b8; margin-top: 2px; }

/* tag groups */
.hdc-tag-group { display: flex; flex-wrap: wrap; align-items: center; gap: 8px; }
.hdc-tag-group-label { font-size: 11px; color: #64748b; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; min-width: 36px; }
.hdc-modality-tag { display: inline-flex; align-items: center; min-height: 26px; padding: 0 10px; border-radius: 999px; background: rgba(96,165,250,0.1); border: 1px solid rgba(96,165,250,0.2); color: #bfdbfe; font-size: 12px; }
.hdc-scope-tag { display: inline-flex; align-items: center; min-height: 26px; padding: 0 10px; border-radius: 999px; background: rgba(52,211,153,0.08); border: 1px solid rgba(52,211,153,0.18); color: #bbf7d0; font-size: 12px; }

/* source pills */
.hdc-source-row { display: flex; flex-wrap: wrap; gap: 10px; }
...
/* radar */
.hdc-radar-chart { width: 100%; min-height: 300px; border-radius: 20px; border: 1px solid rgba(148,163,184,0.1); background: rgba(2,6,23,0.3); }
...
@media (max-width: 720px) { .hdc-panel { padding: 20px; } .hdc-radar-chart { min-height: 220px; } .hdc-section-card { padding: 16px; } }
</style>
